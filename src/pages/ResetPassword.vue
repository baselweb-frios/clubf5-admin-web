...
/>
      ...
      <div>
        <div class="h-2 bg-dark-border rounded overflow-hidden">
          <div
:class="`h-full rounded strength-${passwordStrength.level}`"
...
La contraseña debe contener:
        ...
        <ul class="space-y-2 text-sm text-text-secondary">
          <li
:class="{ 'text-success-400': hasMinLength }"
...
/></svg>
          ...
          <li
:class="{ 'text-success-400': hasUpperCase }"
class="flex items-center gap-2"
>
            <svg
class="w-4 h-4"
...
/></svg>
          ...
          <li
:class="{ 'text-success-400': hasLowerCase }"
class="flex items-center gap-2"
>
            <svg
class="w-4 h-4"
...
/></svg>
          ...
          <li
:class="{ 'text-success-400': hasNumber }"
class="flex items-center gap-2"
>
            <svg
class="w-4 h-4"
