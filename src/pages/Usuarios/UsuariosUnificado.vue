          ...
          <form :key="formKey" class="space-y-4" autocomplete="off" @submit.prevent="guardar">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div class="form-group">
                ...
                <input v-model="formData.username" type="text" class="input" autocomplete="off" :disabled="editMode"
                  required>
              </div>
              ...
              <template v-if="!editMode">
                <div class="form-group">
                  ...
                  <input v-model="formData.password" type="password" class="input" autocomplete="new-password"
                    placeholder="********" required>
                </div>
                <div class="form-group">
                  <label class="label">Repetir Contrasena *</label>
                  <input v-model="formData.re_password" type="password" class="input" autocomplete="new-password"
                    placeholder="********" required>
                </div>
              </template>
