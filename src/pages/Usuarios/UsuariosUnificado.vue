...
/>
    ...
    <!-- Tabs -->
    <div class="flex gap-2 p-1 bg-dark-secondary rounded-lg mb-6 w-fit">
      <button
        :class="[
...
>
              ...
              <td>
                <div class="flex items-center gap-3">
                  <div class="w-8 h-8 rounded-full bg-gradient-to-br from-primary-500 to-accent-purple flex-center text-white text-xs font-medium">
      ...
      <div class="lg:hidden grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        >
          <div class="flex-between mb-4">
            <div class="flex items-center gap-3">
              <div class="w-10 h-10 rounded-full bg-gradient-to-br from-primary-500 to-accent-purple flex-center text-white font-medium">
                {{ getInitials(item.nombre) }}
              </div>
              <div>
...
>
        <div class="modal-header">
          <div class="flex items-center gap-3">
            <div :class="['w-10 h-10 rounded-xl flex-center', editMode ? 'bg-warning-500/20 text-warning-400' : 'bg-primary-500/20 text-primary-400']">
              <svg
class="w-5 h-5"
fill="none"
stroke="currentColor"
...
class="modal-backdrop"
@click.self="closeAprobarConfirm"
>
      <div
class="modal max-w-md"
@click.stop
...
class="modal-backdrop"
@click.self="closeRechazarConfirm"
>
      <div
class="modal max-w-md"
@click.stop
